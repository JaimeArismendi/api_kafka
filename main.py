...
try:
    cursor.execute("""
    CREATE TABLE IF NOT EXISTS transactions_jaimearismendi (
...
consumer_conf = {
    ...
    'group.id': 'transactions_jaimearismendi',
    'auto.offset.reset': 'earliest'
}

consumer = Consumer(consumer_conf)
consumer.subscribe(['transactions_jaimearismendi'])
...
async def process_transaction(transaction_data):
    try:
        ...
        cursor.execute("""
            INSERT INTO transactions_jaimearismendi (
                transaction_json,
